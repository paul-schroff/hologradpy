...
#
# Here, we only show the signal region on the camera. The experimental errors in the camera image are greatly reduced
# after 10 camera feedback iterations with 50 CG iterations each:
#
